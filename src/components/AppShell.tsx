...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-dvh bg-black md:flex md:items-center md:justify-center md:py-4">
      <div
        id="phone-root"
        className="relative mx-auto flex h-dvh w-full max-w-[430px] flex-col overflow-hidden bg-bg md:h-[min(900px,100dvh)] md:rounded-[32px] md:border md:border-white/10 md:shadow-[0_30px_80px_rgba(0,0,0,0.55)]"
      >
        {syncHint && (
